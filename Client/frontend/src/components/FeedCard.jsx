...
async function getDict(){
  ...
  function handlePostDelete(post) {
    ...
    axios.post('landing/deletePost', {id: post._id}).then((data) => {
      console.log(data)
    })
  }

  function handleDeleteUser(post) {
    axios.post('landing/deleteUser', {id: post.trainerUsername}).then((data) => {
      console.log(data)
    })
  }
          ...
          <div className="top">
            <div className="header">
                ...
                // Brooklyn's page connects to this button
                    <div className={"flex justify-center content-center align-middle items-center gap-2"}>
                      <button
